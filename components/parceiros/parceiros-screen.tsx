  ...
  const openModal = useCallback((partnerToEdit?: Partner) => {
    ...
    if (partnerToEdit) {
      ...
      setForm({
        ...
        telefone: partnerToEdit.telefone ?? "",
                    ...
                    <div className="inline-flex items-center gap-1">
                      {p.telefone && (
                        <a
                          ...
                          className="rounded-lg p-1.5 text-zinc-400 transition-colors hover:bg-emerald-50 hover:text-emerald-600 dark:hover:bg-emerald-950/40 dark:hover:text-emerald-400"
